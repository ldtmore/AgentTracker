...
- **阶段**:阶段 3(实施)进行中,**M0 已收尾(2026-09-17);M1 进行中**。
  ...
  M1-7 审查修复+文档回写完成;**M1-4 双主题验收通过(2026-09-17,含审查优化:
  浅色贴边标签 hover 压暗反馈)**;**M1-5 悬浮球划出不做了(2026-09-17 所有者拍板,
  被 M1-6 覆盖)**;M1-2 ⬜(等所有者清单)——**M1 剩余两项均在等所有者输入**
